...
/**
 * Servlet implementation class updatePrerequisiteServlet
 */
@WebServlet("/updatePrerequisiteServlet")
public class updatePrerequisiteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updatePrerequisiteServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String prerequisite1=prerequisite[2];
		 ...
		 courseDao.updatePrerequisite(ID,presentcourse,prerequisite1);
