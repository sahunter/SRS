...
/**
 * Servlet implementation class deletePrerequisiteServlet
 */
@WebServlet("/deletePrerequisiteServlet")
public class deletePrerequisiteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public deletePrerequisiteServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String prerequisite1=prerequisite[2];
		 ...
		 courseDao.deletePrerequisite(ID,presentcourse,prerequisite1);
